    ...
    <Menu :model="items" :pt="{
      ...
      <template #start>
                <span class="inline-flex items-center gap-1 px-2 py-2">
                    <svg class="h-8" fill="none" height="40" viewBox="0 0 35 40" width="35"
                    ...
                    <span class="text-xl font-semibold">FILE<span class="text-primary">SHARING</span></span>
                </span>
      </template>
...
const visible = computed(() => settingStore.getSideBarVisible)
const items = ref([
  {
    separator: true
  },
